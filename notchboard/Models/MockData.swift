...
enum MockData {
    ...
    private static let productsFields = [
        ...
        NBField(key: "tier", label: "tier", type: .picker, options: ["core", "premium", "limited"]),
    ]
    ...
    static func workspace() -> NBWorkspace {
        let users = NBGroup(
            ...
            fields: usersFields,
            elements: [
                // Multi-environment on purpose: the same seeded account exists in dev and
                // staging, which is the common case a single-env model forced people to
                // duplicate.
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000001", name: "Ava Lindqvist", environments: [.dev, .stg], isFavorite: true,
                          claimedBy: nil,
                ...
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000002", name: "Empty State", environments: [.dev, .stg], isFavorite: false,
                          claimedBy: nil,
                          note: "brand new account — triggers every empty-state screen",
                          lastUsed: "2 days ago",
                          values: ["username": "qa.empty@acme.dev", "password": "Empty#2026"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000003", name: "Premium Annual", environments: [.dev], isFavorite: false,
                          claimedBy: nil,
                          note: "active subscription, renews 07/12",
                          lastUsed: "yesterday",
                          values: ["username": "premium.annual@acme.dev", "password": "G0ld-tier#"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000004", name: "No Payment Method", environments: [.stg], isFavorite: false,
                          claimedBy: nil,
                          note: "no card on file — use for checkout error path",
                          lastUsed: "today",
                          values: ["username": "qa.nopay@acme.dev", "password": "N0pay-2026"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000005", name: "Fresh Signup", environments: [.dev], isFavorite: false,
                          claimedBy: nil,
                          note: "onboarding incomplete, stops at step 2",
                          lastUsed: "4 days ago",
                          values: ["username": "fresh.signup@acme.dev", "password": "Fresh#001"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000006", name: "Locale DE", environments: [.stg], isFavorite: false,
                          claimedBy: nil,
                          note: "German locale, EUR currency, VAT edge cases",
                          lastUsed: "last week",
                          values: ["username": "qa.de@acme.dev", "password": "Str4sse!9"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000007", name: "Heavy Cart", environments: [.stg], isFavorite: false,
                          claimedBy: nil,
                          note: "42 items in cart — perf + scroll testing",
                          lastUsed: "3 days ago",
                          values: ["username": "qa.cart@acme.dev", "password": "C4rt-heavy"]),
                NBElement(id: "6D0E1C1E-0001-4A00-9000-000000000008", name: "PRD Smoke", environments: [.prd], isFavorite: false,
                          claimedBy: nil,
        ...
        let products = NBGroup(
            ...
            elements: [
                NBElement(id: "6D0E1C1E-0002-4A00-9000-000000000001", name: "Flat White Beans 1kg", environments: [.dev], isFavorite: true,
                          claimedBy: nil, note: "hero product, always in stock", lastUsed: "today",
                          values: ["sku": "BW-1041", "price": "18.50", "stock": "true", "tier": "core"]),
                NBElement(id: "6D0E1C1E-0002-4A00-9000-000000000002", name: "Decaf Blend 250g", environments: [.dev], isFavorite: false,
                          claimedBy: nil, note: "", lastUsed: "—",
                          values: ["sku": "BW-2010", "price": "7.90", "stock": "true", "tier": "core"]),
                NBElement(id: "6D0E1C1E-0002-4A00-9000-000000000003", name: "Grinder Pro X", environments: [.dev], isFavorite: false,
                ...
                NBElement(id: "6D0E1C1E-0002-4A00-9000-000000000004", name: "Gift Card 25", environments: [.stg], isFavorite: false,
                          claimedBy: nil, note: "digital delivery, no shipping step", lastUsed: "—",
                          values: ["sku": "GC-0025", "price": "25.00", "stock": "true", "tier": "core"]),
                NBElement(id: "6D0E1C1E-0002-4A00-9000-000000000005", name: "Subscription Sampler", environments: [.stg], isFavorite: false,
        ...
        let promos = NBGroup(
            ...
            fields: promosFields,
            elements: [
                NBElement(id: "6D0E1C1E-0003-4A00-9000-000000000001", name: "WELCOME10", environments: [.dev], isFavorite: true,
                          claimedBy: nil, note: "new accounts only", lastUsed: "today",
                          values: ["discount_pct": "10", "expires": "2026-12-31", "single_use": "true"]),
                NBElement(id: "6D0E1C1E-0003-4A00-9000-000000000002", name: "FREESHIP", environments: [.dev], isFavorite: false,
                          claimedBy: nil, note: "", lastUsed: "—",
                          values: ["discount_pct": "0", "expires": "2026-09-01", "single_use": "false"]),
                NBElement(id: "6D0E1C1E-0003-4A00-9000-000000000003", name: "VIP25", environments: [.stg], isFavorite: false,
                          claimedBy: nil, note: "premium tier only", lastUsed: "today",
                          values: ["discount_pct": "25", "expires": "2026-08-15", "single_use": "true"]),
                NBElement(id: "6D0E1C1E-0003-4A00-9000-000000000004", name: "BLACKFRI", environments: [.stg], isFavorite: false,
        ...
        let endpoints = NBGroup(
            ...
            elements: [
                NBElement(id: "6D0E1C1E-0004-4A00-9000-000000000001", name: "API dev", environments: [.dev], isFavorite: false,
                          claimedBy: nil, note: "resets nightly at 02:00 UTC", lastUsed: "today",
                          values: ["base_url": "https://api.dev.acme.dev", "token": "dev-5f2a91c4"]),
                NBElement(id: "6D0E1C1E-0004-4A00-9000-000000000002", name: "API staging", environments: [.stg], isFavorite: false,
                ...
                NBElement(id: "6D0E1C1E-0004-4A00-9000-000000000003", name: "API prod", environments: [.prd], isFavorite: false,
