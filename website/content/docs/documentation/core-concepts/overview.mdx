...
import { Layers, Lock, Network } from 'lucide-react';

<Cards>
  <Card icon={<Network />} href="./collections-groups-and-elements.mdx" title="Collections, groups and elements">
    The four levels of the catalogue, and how they nest.
  </Card>
  <Card icon={<Lock />} href="./field-types-and-secrets.mdx" title="Field types and secrets">
    Seven field types, and what marking one `secret` actually does.
  </Card>
  <Card icon={<Layers />} href="./environments.mdx" title="Environments">
    Why an element carries a set of environments rather than one.
  </Card>
</Cards>
