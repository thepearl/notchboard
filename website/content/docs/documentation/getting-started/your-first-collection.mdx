...
![The new group form, a name and a list of fields](../assets/new-group-form.png)

*A group is its schema, a name plus the fields every element shares.*
</Step>
...
![The add-element form for a users group](../assets/new-user-form.png)

*The group's schema decides the fields. The password field is typed secret, so lists mask it.*
...
<Cards>
  <Card href="../core-concepts/overview.mdx" title="Core concepts" />
